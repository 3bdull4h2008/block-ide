...
export const PALETTE_GROUPS: PaletteGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'return', cat: 'statement', snippet: 'return value', langs: ['python'] },
      { name: 'assign +=', cat: 'statement', snippet: 'value += 1', langs: ['python'] },
      { name: 'list', cat: 'statement', snippet: 'items = []', langs: ['python'] },
      { name: 'append', cat: 'statement', snippet: 'items.append(value)', langs: ['python'] },
      { name: 'len', cat: 'statement', snippet: 'len(items)', reporter: 'round', langs: ['python'] },
      { name: 'import', cat: 'statement', snippet: 'import module', top: true, langs: ['python'] },
      { name: 'from import', cat: 'statement', snippet: 'from module import name', top: true, langs: ['python'] },
      // javascript
      ...
      { name: 'const', cat: 'statement', snippet: 'const value = 0;', langs: ['javascript'] },
      { name: 'prompt', cat: 'statement', snippet: 'const answer = prompt("question");', langs: ['javascript'] },
      { name: 'array', cat: 'statement', snippet: 'const items = [];', langs: ['javascript'] },
      { name: 'push', cat: 'statement', snippet: 'items.push(value);', langs: ['javascript'] },
      // rust
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'method', cat: 'structs', snippet: 'myMethod() {\n    return this.x;\n}', langs: ['javascript'] },
